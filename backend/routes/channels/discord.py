...
# ---- plugin contribution (batch 3c.5): this router belongs to builtin.channels.discord and is
...
ROUTES = (Contribution("channel_discord", lambda: RouterSpec(router, "/api/discord", tags=('Discord',))),)
