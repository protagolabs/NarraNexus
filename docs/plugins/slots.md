...
| `builtin.chat` | 1.0.0 | backend, mcp, workers | `agent.capabilities.modules`, `ingress.triggers`, `backend.hooks` | gold |
| `builtin.social_network` | 1.0.0 | backend, mcp, workers | `agent.capabilities.modules` | gold |
| `builtin.job` | 1.0.0 | backend, mcp, workers | `agent.capabilities.modules`, `ingress.triggers` | gold |
