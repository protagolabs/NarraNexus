...
export function SkillMarketplaceTab() {
  ...
  return (
    <div className="flex flex-col h-full" data-testid="skill-marketplace-tab">
      ...
      {installError && (
        <div className="mx-6 mb-2 flex items-center gap-2 px-3 py-2 rounded-[var(--radius-lg)] bg-[var(--color-error)]/10 border border-[var(--color-error)]/20">
