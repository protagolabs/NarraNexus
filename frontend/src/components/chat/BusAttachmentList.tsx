...
function BusAttachmentChip({ att }: { att: BusAttachment }) {
  ...
  return (
    <button
      ...
      className="flex max-w-[280px] items-center gap-2 rounded-[var(--radius-md)] border border-[var(--rule)] bg-[var(--bg-tertiary)]/40 px-2 py-1.5 text-left hover:bg-[var(--bg-tertiary)]/70"
    >
