...
PAGES.register('setup', { path: '/setup', element: lazy(() => import('@/pages/SetupPage')), guard: 'protected', layout: 'top' }, OWNER);
...
PAGES.register('pay', { path: '/pay', element: lazy(() => import('@/pages/PayPage')), guard: 'protected', layout: 'top' }, OWNER);
