...
export const mockJobs: Job[] = [
  {
    ...
    status: 'running',
    trigger_config: { cron: '0 9 * * MON', timezone: 'Asia/Shanghai' },
  ...
  },
  {
    ...
    status: 'pending',
    trigger_config: { run_at: localDateTime(20 * ONE_MIN), timezone: 'Asia/Shanghai' },
  ...
  },
  {
    ...
    status: 'active',
    trigger_config: { interval_seconds: 60, timezone: 'Asia/Shanghai' },
  ...
  },
  {
    ...
    status: 'completed',
    trigger_config: { cron: '45 8 * * 1-5', timezone: 'Asia/Shanghai' },
  ...
  },
  {
    ...
    status: 'paused',
    trigger_config: { cron: '0 10 1 */3 *', timezone: 'Asia/Shanghai' },
...
const ownedAtlas: OwnedAgentStatus = {
  ...
  queue: { running: 1, active: 1, pending: 2, blocked: 1, paused: 1, failed: 1, cooling: 0, paused_no_quota: 0, blocked_failed: 0, paused_spend_cap: 0, total: 7 },
  recent_events: [
...
const ownedScribe: OwnedAgentStatus = {
  ...
  queue: { running: 0, active: 0, pending: 0, blocked: 0, paused: 0, failed: 0, cooling: 0, paused_no_quota: 0, blocked_failed: 0, paused_spend_cap: 0, total: 0 },
  recent_events: [
...
const ownedSentry: OwnedAgentStatus = {
  ...
  queue: { running: 1, active: 0, pending: 0, blocked: 0, paused: 0, failed: 1, cooling: 0, paused_no_quota: 0, blocked_failed: 0, paused_spend_cap: 0, total: 2 },
  recent_events: [
