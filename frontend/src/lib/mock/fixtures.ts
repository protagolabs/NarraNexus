...
export const mockSocialEntities: SocialNetworkEntity[] = [
  {
    ...
    contact_info: { email: 'demo.user@netmind.ai' },
    tags: ['owner'],
    keywords: ['owner'],
  ...
  {
    entity_id: 'entity_chen_li',
    entity_name: 'Prof. Chen Li',
    aliases: ['chen.li@tsinghua.edu.cn', 'Chen Li (清华)'],
    ...
    entity_type: 'contact',
    familiarity: 'direct',
    identity_info: { org: 'Tsinghua University', role: 'Associate Professor' },
    contact_info: { email: 'chen.li@tsinghua.edu.cn', phone: '+86 10 6277 xxxx' },
    tags: ['academic', 'rlhf'],
  ...
  },
  {
    ...
    contact_info: { email: 'dana.kim@netmind.ai', slack: '@dana' },
    tags: ['internal'],
  ...
  },
  {
    ...
    contact_info: { email: 'mira@anthropic.com' },
    tags: ['external'],
...
export const mockNarratives: ChatHistoryNarrative[] = [
  {
    ...
    current_summary: 'User and Atlas have established a weekly cadence for digesting alignment research. Recent focus has been on RLHF follow-ups and Prof. Chen\'s latest preprint.',
    actors: [
      { id: MOCK_USER_ID, type: 'user' },
      { id: 'entity_chen_li', type: 'contact' },
    ],
    created_at: iso(-14 * ONE_DAY),
    updated_at: iso(-2 * ONE_MIN),
