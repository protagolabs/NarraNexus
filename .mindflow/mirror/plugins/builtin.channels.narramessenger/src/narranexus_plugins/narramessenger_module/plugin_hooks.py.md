---
code_file: plugins/builtin.channels.narramessenger/src/narranexus_plugins/narramessenger_module/plugin_hooks.py
last_verified: 2026-09-04
stub: false
---

# narramessenger_module/plugin_hooks.py — Manyfold credential export
