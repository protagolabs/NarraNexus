---
code_file: plugins/builtin.channels.discord/src/narranexus_plugins/discord_module/plugin_hooks.py
last_verified: 2026-09-04
stub: false
---

# discord_module/plugin_hooks.py — Manyfold credential export
