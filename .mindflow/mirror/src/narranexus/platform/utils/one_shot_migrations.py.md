---
code_file: src/narranexus/platform/utils/one_shot_migrations.py
...
- **不要再抄 cloud/local 判定副本**——任何"避免循环 import"的复制都可能悄悄漂移。统一 `from narranexus.platform.utils.deployment_mode import is_cloud_mode`。
