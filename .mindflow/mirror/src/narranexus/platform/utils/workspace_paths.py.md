---
code_file: src/narranexus/platform/utils/workspace_paths.py
stub: false
...
skill_backup, bootstrap, skill_module, attachment_storage, the artifact subsystem (narranexus/platform/artifact),
