---
code_file: src/narranexus/platform/module_system/lark_module/lark_trigger.py
stub: false
...
`LarkTrigger` is now a subclass of `narranexus.platform.channel.channel_trigger_base.ChannelTriggerBase`.
