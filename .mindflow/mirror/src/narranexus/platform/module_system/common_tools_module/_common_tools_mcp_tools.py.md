---
code_file: src/narranexus/platform/module_system/common_tools_module/_common_tools_mcp_tools.py
...
- DDGS backend 细节：`.mindflow/mirror/src/narranexus/platform/module_system/common_tools_module/_common_tools_impl/web_search_ddgs_tool.py.md`
- artifact tool 注册细节：`.mindflow/mirror/src/narranexus/platform/module_system/common_tools_module/_common_tools_impl/artifact_tool.py.md`
