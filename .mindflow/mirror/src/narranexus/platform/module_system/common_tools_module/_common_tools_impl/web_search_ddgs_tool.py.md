---
code_file: src/narranexus/platform/module_system/common_tools_module/_common_tools_impl/web_search_ddgs_tool.py
...
- 详见 `.mindflow/mirror/src/narranexus/platform/module_system/common_tools_module/_common_tools_mcp_tools.py.md`——factory 和 dispatch 逻辑在那
