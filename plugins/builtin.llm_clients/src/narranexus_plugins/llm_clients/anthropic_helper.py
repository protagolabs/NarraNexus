...
from narranexus.platform.agent_framework.api_config import anthropic_helper_config
...
class AnthropicHelperSDK:
    ...
    def _resolve_model(requested_model: str | None) -> str:
        ...
        """
        from narranexus.platform.agent_framework.api_config import AnthropicHelperConfig
    ...
    def _max_tokens_for(model_name: str) -> int:
        from narranexus.platform.agent_framework.providers.model_catalog import get_max_output_tokens
