...
@author: Bin Liang
@date: 2026-09-04
@description: Package contract of `builtin.memory_kinds`: the manifest file equals the host's builtin manifest and every provided symbol resolves inside this package.
"""
