            ...
            return [
                {
                    ...
                    "data": {
                        ...
                        # DATA_TYPE_ERROR handling. The value is loop.py's
                        # own verdict (``_fail``), passed through verbatim;
                        # the True default is only a fallback should
                        # ``_fail`` ever stop setting the key.
