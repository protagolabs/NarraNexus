...
class ClaudeAgentSDK:
    ...
    # TODO: Input is not ideal; should use a pydantic model for validation. Store it in src/narranexus/platform/agent_framework/schema.py.
    ...
    async def agent_loop(
        ...
        **kwargs: Any,
        ...
        async def _run_with_transient_retry(
            ...
            """
            from narranexus.platform.settings import settings as _s
