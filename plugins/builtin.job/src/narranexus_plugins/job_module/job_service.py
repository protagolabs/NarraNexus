...
if TYPE_CHECKING:
    ...
    from narranexus.platform.schema.job_schema import JobModel
...
class JobInstanceService:
    ...
    async def create_job_with_instance(
        ...
        """
        from narranexus.platform.schema.job_schema import JobType, TriggerConfig, JobStatus
        from narranexus.platform.repository import JobRepository, InstanceRepository, NarrativeRepository
        ...
        from narranexus.platform.narrative.models import NarrativeActorType, NarrativeActor
    ...
    async def update_job(
        ...
        try:
            ...
            from narranexus.platform.schema.job_schema import JobStatus, JobType
