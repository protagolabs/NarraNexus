...
@author: Bin Liang
@date: 2026-09-07
@description: What ``builtin.channels.slack`` contributes to the host, as the objects its manifest names. The plugin owns this table; the platform holds no list of builtins.
"""
