...
@author: Bin Liang
@date: 2026-09-04
@description: Public facade of the `builtin.channels.lark` plugin package — what another plugin or a distribution may import.

Everything else under `narranexus_plugins.lark_module` is private to the plugin; the
