...
@author: Bin Liang
@date: 2026-09-07
@description: What ``builtin.channels.lark`` contributes to the host, as the objects its manifest names. The plugin owns this table; the platform holds no list of builtins.
"""
from __future__ import annotations

from narranexus.platform.channel.contributions import contributions_from
from narranexus_plugins.lark_module.descriptor import DESCRIPTOR
