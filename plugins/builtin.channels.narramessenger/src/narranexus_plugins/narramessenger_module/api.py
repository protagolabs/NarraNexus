...
@author: Bin Liang
@date: 2026-09-04
@description: Public facade of the `builtin.channels.narramessenger` plugin package — what another plugin or a distribution may import.

Everything else under `narranexus_plugins.narramessenger_module` is private to the plugin; the
...
PLUGIN_ID = "builtin.channels.narramessenger"
PACKAGE = "narranexus_plugins.narramessenger_module"
