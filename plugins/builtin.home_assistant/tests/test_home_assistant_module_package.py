...
@author: Bin Liang
@date: 2026-09-04
@description: Package contract of `builtin.home_assistant`: the manifest file equals the host's builtin manifest, the facade resolves the module class, and the package imports only the engine.
"""
