...
def create_skill_mcp_server() -> FastMCP:
        ...
        **WHEN TO CALL**: After completing registration or setup for a skill, call this
        ...
        try:
            ...
            for key in required_env:
                # Platform-resolved vars (e.g. NETMIND_API_KEY) have no stored
                # value — resolved fresh per run — so count them configured
                # here too, matching the other five is-configured checks.
                configured = key in configured_set or key in PLATFORM_RESOLVED_ENV
    ...
    async def skill_backup_from_github(
        ...
        **WHEN TO CALL**: Right after you successfully install a skill from a GitHub
        ...
        """
        try:
            from narranexus.platform.bundle.skill_backup import (
    ...
    async def skill_list_unbackedup(
        ...
        **WHEN TO CALL**: Proactively before the user asks to export a bundle, OR
        ...
        """
        try:
            from narranexus.platform.bundle.skill_backup import list_unbackedup
    ...
    async def skill_search_marketplace(
        ...
        **WHEN TO CALL**: The user asks for a capability you don't have, or asks
        ...
        """
        try:
            from narranexus.platform.marketplace.skill_marketplace_service import SkillMarketplaceService
