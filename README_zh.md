...
| 维度 | OpenClaw | WorkBuddy / AionUI | NarraNexus |
|---|---|---|---|
| 产品定位 | 面向个人的自托管执行型 Agent，强调自动化、渠道接入和本地控制 | WorkBuddy 偏多 Agent Cowork 工作台；AionUI 偏自托管个人 Agent 平台 | 赋予 Agent 生命力，创建、运行和管理长期工作的 AI 团队 |
