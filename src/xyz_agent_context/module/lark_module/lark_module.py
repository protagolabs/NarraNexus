...
class LarkModule(XYZBaseModule):
    ...
    async def get_instructions(self, ctx_data: ContextData) -> str:
        ...
        return (
            ...
            f"- **Contacts**: Search colleagues by name/email/phone\n"
            f"- **Messaging**: Send messages, reply, search chat history, create groups\n"
            f"- **Documents**: Create, read, update, and search Lark documents\n"
            f"- **Calendar**: View agenda, create events, check free/busy status\n"
            f"- **Tasks**: Create tasks, view my tasks, mark complete\n\n"
