...
class LarkModule(XYZBaseModule):
    ...
    async def get_instructions(self, ctx_data: ContextData) -> str:
        ...
        return (
            ...
            f"If a tool returns a permission error, tell the user which permission needs to be "
            f"enabled in the Lark Open Platform, do NOT initiate OAuth login unless the tool "
            f"explicitly says it requires user identity.\n\n"
