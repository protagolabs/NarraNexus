...
#
# Retention: swept by ChannelTriggerBase._run_cleanup alongside the dedup and
# audit tables — a closed (tier=0) row that has not moved in N days is a
# conversation that recovered and can be forgotten.
# ----------------------------------------------------------------------------
_register(
    TableDef(
