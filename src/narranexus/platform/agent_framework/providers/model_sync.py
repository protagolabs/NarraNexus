...
def _free_tier_wallet_client():
    ...
    from narranexus.platform.integrations.free_tier.wallet_client import WalletClient
...
async def refresh_free_tier_models(db, *, ledger: dict[str, Any] | None = None) -> int:
    ...
    from narranexus.platform.integrations.free_tier.wallet_client import WalletError
