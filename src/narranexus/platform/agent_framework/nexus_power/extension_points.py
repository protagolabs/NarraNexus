...
_PROTOCOLS = "narranexus.platform.agent_framework.nexus_power.contracts.protocols"
...
def _disallowed_tools(ctx: SeatContext):
    from narranexus.platform.agent_framework.nexus_power._nexus_power_impl.tooling.policy import DisallowedToolsLayer

    return DisallowedToolsLayer()


def _workspace_confinement(ctx: SeatContext):
    from narranexus.platform.agent_framework.nexus_power._nexus_power_impl.tooling.policy import WorkspaceConfinementLayer

    return WorkspaceConfinementLayer()


def _shell_confinement(ctx: SeatContext):
    from narranexus.platform.agent_framework.nexus_power._nexus_power_impl.tooling.policy import ShellConfinementLayer
