...
def _prewarm() -> None:
    ...
    from narranexus.platform.agent_framework.nexus_power import assembly  # noqa: F401
    from narranexus.platform.agent_framework.nexus_power._nexus_power_impl import (  # noqa: F401
        event_adapter,
        loop,
    )
...
def main() -> None:
    """``python -m narranexus.platform.agent_framework.nexus_power.runner``:
