...
if TYPE_CHECKING:
    ...
    from narranexus.platform.narrative import NarrativeService, NarrativeMarkdownManager
    from narranexus.platform.schema.module_schema import ModuleInstance
...
async def step_2_5_sync_instances(
    ...
    if has_raw_instances and load_result.raw_instances:
        ...
        from narranexus.platform.services import InstanceSyncService
