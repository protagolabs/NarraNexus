...
from narranexus.platform.repository import AgentRepository, InstanceRepository, InstanceAwarenessRepository
from narranexus.platform.module_system import ModuleService

if TYPE_CHECKING:
    from .context import RunContext
    from narranexus.platform.utils import DatabaseClient
    from narranexus.platform.narrative import EventService, SessionService
