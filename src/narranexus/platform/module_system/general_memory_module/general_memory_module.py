...
from narranexus.platform.memory import MemoryCoordinator, MemoryEngine, MemoryRecord, SCOPE_AGENT, get_spec, passive_kinds
...
from narranexus.platform.schema.hook_schema import HookAfterExecutionParams
from narranexus.platform.schema.module_schema import ModuleConfig, MCPServerConfig
...
class GeneralMemoryModule(XYZBaseModule):
    ...
    def create_mcp_server(self) -> Optional[object]:
        from narranexus.platform.module_system.general_memory_module._general_memory_mcp_tools import (
