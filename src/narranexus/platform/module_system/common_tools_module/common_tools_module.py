...
from narranexus.platform.artifact import ArtifactService, office_lock_present
...
class CommonToolsModule(XYZBaseModule):
    ...
    async def _render_artifact_state_block(self) -> str:
        ...
        if not self.db:
            return ""
        try:
            from narranexus.platform.repository.artifact_repository import (
                ArtifactRepository,
            )
        ...
        from narranexus.platform.module_system.common_tools_module._common_tools_impl.artifact_lines import (
    ...
    def create_mcp_server(self) -> Optional[Any]:
        from narranexus.platform.module_system.common_tools_module._common_tools_mcp_tools import (
