...
Runs as ``python -m narranexus.platform.module_system.common_tools_module._common_tools_impl.web_search_runner``.
...
from narranexus.platform.module_system.common_tools_module._common_tools_impl.web_search import (
    search_many,
)
