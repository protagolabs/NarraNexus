...
DESCRIPTOR = ChannelDescriptor(
    ...
    credential_manager_ref="narranexus.platform.module_system.home_assistant_module._home_assistant_impl.binding:HomeAssistantCredentialManager",
    module_ref="narranexus.platform.module_system.home_assistant_module.home_assistant_module:HomeAssistantModule",
    has_bind=False,
    has_test=False,
)
