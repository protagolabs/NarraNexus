...
from narranexus.platform.module_system.home_assistant_module._home_assistant_impl.ha_client import HAError
from narranexus.platform.module_system.home_assistant_module.prompts import HOME_ASSISTANT_MODULE_INSTRUCTIONS
from narranexus.platform.schema.module_schema import ModuleAgentInstance
from narranexus.platform.schema import MCPServerConfig, ModuleConfig
