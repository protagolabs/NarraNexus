...
from narranexus.platform.schema import ContextData, HookAfterExecutionParams
from narranexus.platform.schema.module_schema import HookCallbackResult
...
if TYPE_CHECKING:
    from narranexus.platform.narrative import Narrative, NarrativeService
    ...
    async def hook_callback_results(
        ...
        for callback in hook_callback_results:
            ...
            for activated_instance_id in newly_activated:
                ...
                from narranexus.platform.utils.background_tasks import spawn
