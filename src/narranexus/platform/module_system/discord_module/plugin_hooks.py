...
@author: Bin Liang
@date: 2026-09-04
@description: ``backend.hooks`` implementations the builtin.channels.discord plugin ships (Manyfold credential export).
...
async def export_credentials(db: Any) -> list[dict[str, Any]]:
    from narranexus.platform.module_system.discord_module._discord_credential_manager import DiscordCredentialManager
