...
class NexusPluginsModule(XYZBaseModule):
    ...
    async def contribute_instructions(self, ctx_data: ContextData) -> str:
        if is_cloud_mode():
            return ""
        from narranexus.platform.module_system.nexus_plugins_module._nexus_plugins_impl.state import summary_for_agent
    ...
    def create_mcp_server(self) -> Optional[Any]:
        from narranexus.platform.module_system.nexus_plugins_module._nexus_plugins_impl.tools import create_nexus_plugins_mcp_server
