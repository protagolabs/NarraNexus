...
ROOT = Path(__file__).resolve().parents[6]  # the repo root (src/narranexus/platform/module_system/nexus_plugins_module/_nexus_plugins_impl/ is six levels down); PYTHONPATH below needs ROOT/src AND ROOT
