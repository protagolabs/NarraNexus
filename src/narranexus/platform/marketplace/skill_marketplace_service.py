...
class SkillMarketplaceService:
    ...
    def _annotate_installed(self, items: List[Dict[str, Any]], agent_id: str, user_id: str) -> None:
        from narranexus.platform.repository.skill_catalog_repository import _semver_key
    ...
    async def install(
        ...
        from narranexus.platform.marketplace._skill_marketplace_impl.registry import LocalMarketplaceSource
