...
from narranexus.platform.utils.db.database import _mysql_to_sqlite_sql
from narranexus.platform.utils.db.db_backend_sqlite import SQLiteBackend
from narranexus.platform.utils.db.db_factory import detect_backend_type, parse_sqlite_url
...
def main() -> int:
    ...
    uvicorn.run(
        "narranexus.platform.utils.db.sqlite_proxy_server:app",
        host="127.0.0.1",
        port=port,
        log_level="info",
    )
