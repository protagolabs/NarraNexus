...
BUILTIN_MANIFEST_DATA: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_AWARENESS"]},
        "quality": "gold",
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_BASIC_INFO"]},
        "quality": "gold",
    },
    {
        "id": "builtin.chat",
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHAT"]},
        "quality": "gold",
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_SOCIAL_NETWORK"]},
        "quality": "gold",
    },
    {
        "id": "builtin.job",
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_JOB"]},
        "quality": "gold",
    },
    {
        "id": "builtin.skills",
    ...
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHANNELS_LARK"]},
        "quality": "gold",
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHANNELS_SLACK"]},
        "quality": "gold",
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHANNELS_TELEGRAM"]},
        "quality": "gold",
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHANNELS_WECHAT"]},
        "quality": "gold",
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHANNELS_NARRAMESSENGER"]},
        "quality": "gold",
    },
    {
