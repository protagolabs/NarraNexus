...
BUILTIN_MANIFEST_DATA: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "hosts": ["backend", "mcp", "workers"],
        "api": {"module": 0, "trigger": 0, "hook": 0},
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_CHAT"], "ingress.triggers": ["xyz_agent_context.module.contributions:TRIGGERS_CHAT"], "backend.hooks": ["xyz_agent_context.module.chat_module.plugin_hooks:HOOKS"]},
        "quality": "gold",
    },
    {
    ...
    },
    {
        ...
        "provides": {"agent.capabilities.modules": [f"{_MODULE}.contributions:PLUGIN_JOB"], "ingress.triggers": ["xyz_agent_context.module.contributions:TRIGGERS_JOB"]},
        "quality": "gold",
    },
    {
        "id": "builtin.skills",
