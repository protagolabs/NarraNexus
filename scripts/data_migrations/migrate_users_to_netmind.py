...
Usage:
    uv run python scripts/data_migrations/migrate_users_to_netmind.py --report
    uv run python scripts/data_migrations/migrate_users_to_netmind.py --execute --mapping m.csv
    uv run python scripts/data_migrations/migrate_users_to_netmind.py --verify --mapping m.csv
"""
