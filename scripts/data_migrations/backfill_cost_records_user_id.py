...
Usage on the EC2 host:
    ...
    uv run python scripts/data_migrations/backfill_cost_records_user_id.py           # dry run
    uv run python scripts/data_migrations/backfill_cost_records_user_id.py --apply   # execute
"""
