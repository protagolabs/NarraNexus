...
Usage:
    uv run python scripts/data_migrations/backfill_netmind_default_models.py
    uv run python scripts/data_migrations/backfill_netmind_default_models.py --dry-run
"""
