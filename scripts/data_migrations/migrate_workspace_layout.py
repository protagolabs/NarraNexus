...
Usage:
    # preview (default)
    uv run python scripts/data_migrations/migrate_workspace_layout.py
    # actually move
    uv run python scripts/data_migrations/migrate_workspace_layout.py --apply
    # explicit base dir
    uv run python scripts/data_migrations/migrate_workspace_layout.py --base /opt/narranexus/workspaces --apply
"""
