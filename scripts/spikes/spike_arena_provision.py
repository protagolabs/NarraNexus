...
Usage:
    uv run python scripts/spikes/spike_arena_provision.py
    uv run python scripts/spikes/spike_arena_provision.py --user-id binliang
    uv run python scripts/spikes/spike_arena_provision.py --no-register   # fake creds
    uv run python scripts/spikes/spike_arena_provision.py --agent-id agent_xxxx  # reuse
"""
