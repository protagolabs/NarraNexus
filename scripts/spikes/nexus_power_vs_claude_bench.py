...
@author: Bin Liang
@date: 2026-07-29
@description: Same-context, driver-level comparison: nexus_power vs
...
Usage:
    uv run python scripts/spikes/nexus_power_vs_claude_bench.py [scenario]
...
async def main() -> None:
    ...
    results = []
    for framework in ("claude_code", "nexus_power"):
        print(f"\n===== {framework} =====")
        try:
